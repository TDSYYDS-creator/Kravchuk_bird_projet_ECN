...
def the_test(signal, alpha, m, folder='samples', functional='K'):
    """
    Summary statistics used to perform the test, with output of threshold and statistic values.
    """
    
    # Signal: observed data to be tested
    # Folder: folder in which the white noise samples are stored
    # Functional: 'F' for the empty space function, 'K' for Ripley's K function
    ...
    # Return the rejection threshold and the summary statistic
    return T_m[-k], t_exp
